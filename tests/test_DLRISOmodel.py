...
def test_energy_flux_output():
    ...
    outputEnergyFlux = DLRISOmodel.getEnergyFluxesFromEnergies(solarModulationWparameter, atomicNumber, energyListInMeV)
...
def test_timestamp_flux_output():
    ...
    outputtedSpectralDataFrame = DLRISOmodel.getSpectrumUsingTimestamp(datetimeToUse,atomicNumber=1)
