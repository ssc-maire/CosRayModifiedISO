...
#@jit(nopython=True)
def getDLRISO_GCR_Flux_Default_Energies(W, Z):
    ...
    outputFluxArray = np.array([[energy,getDLRISO_GCR_Flux_Single(W, Z, energy)] for energy in middleEnergies])
...
def getDLRISO_GCR_Flux_Single(W:float, Z:int, energy:float)->float:
    ...
    if ((W < 0) or (W > 200)):
        ...
        #constants for the PANDOCA model, which are empirical and taken from tabulated data. These constants are a function
        #of atomic number Z.
        ...
        # ==============================================================================
        #       using the main PANDOCA model equation to calculate the output flux
        # ==============================================================================
...
if __name__ == "__main__":
    testW = 111.3
    testZ = 1
    defaultOutputFluxes = getDLRISO_GCR_Flux_Default_Energies(testW, testZ)
    print("Success!")